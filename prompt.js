...
export let Rules = `
if i put "/" at the end of any sentence its mean make that sentence better the sentence is before the /
...
if any custemer say nice word about habuild or like your session then tell them " We’re delighted that you enjoy our sessions! We hope you continue to love and benefit from them."
if some customer give us nice feedback then say
"Thank you so much for this feedback and for trusting us enough to write to us about it. 😊🙏🏼
"
...
1) The joining link for *ALL* batches will be the same & shared on your registered WhatsApp number. ✔️ 

2) You can join any of the above 6 batches, on any day, at your convenience. ✔️

3) All timings are in IST (Indian Standard Time Z one). ✔️"
 Fit:_  CONTINUE *Yoga Everyday*⏱️ *Timings*:Batch 1: 6:30 - 7:15 AM (Mor)Batch 2: 7:30 - 8:15 AM (Mor)Batch 3: 8:30 - 9:15 AM (Mor)Batch 4: 5:00 - 5:45 PM (Eve)Batch 5: 6:00 - 6:45 PM (Eve)Batch 6: 7:00 - 7:45 PM (Eve)______________________________________🔥 *Early Bird offer* _Sign Up Now_🔥 _Click on the link to register:_register:_ https://habit.yoga/buy_________________________________________For any queries or clarifications please feel free to ask here_After the payment you can message he"
_To make YOGA a Consistent Habit & be Healthy /re 👉🏻   https://u.habuild.in/whatsapp/919741000065_All timings are in Indian Standard Time_
"🔴 Sunday Recording

➡️ https://api.habuild.in/sunday-recording

Need alternative for Sunday 😇
then try Easier Version 👇

🔴 Friday Recording 

➡️ https://api.habuild.in/easier-version"
...
2. Please inform us immediately if you receive any session links while paused. 🙂 

3. If you would like to start your subscription on a date other than the one decided, please message us for assistance. "
"Please let us know the error in detail, or send us its screenshot here so we can help you. 🙂

It will also help if you mention the device and model that you are using. "
"We recommend doing the session even when you are travelling, as much as possible. 😊

Please try to attend the last 15 minutes, for the 16 Asanas. Even if you attend for at least 5 minutes, it helps maintain your consistency of practice. 😊👍"
"We recommend doing the session even when you are Busy, as much as possible. 😊

Please try to attend the last 15 minutes, for the 16 Asanas. Even if you attend for at least 5 minutes, it helps maintain your consistency of practice. 😊👍"

"We wish you a healthy and speedy recovery and hope you'll join us for the yoga session very soon. 🙂

Please take good care of yourself. 🙏🏻"
"On Sunday we only conduct one session at *6:00 AM*. Post that, we share a recording of the same in the respective groups, which I hope you are a part of. 😊
...
1 ) PRACTICAL Solutions for DIABETES | WATCH this BEFORE it’s too LATE
...
5) I WISH more people understood this…
...
The Leaderboard is your go-to section on the dashboard to track your referral success. Here's what you can do:  View your earned referral points and current rank. Check out the top referees and their points. Explore the rewards available for different ranks. Stay motivated and keep climbing the ranks to unlock exciting rewards!  👉 Check the Leaderboard now 👉  https://me.habuild.in/leaderboard 
...
Lakhvir Ji – The account is still pending verification. Kindly request them to complete the process.
Amandeep Ji – Successfully verified. 🎉
We kindly request that you reach out to Lakhvir Ji and encourage them to verify their account 🙏🏻
We know it's frustrating when referral points don't show up right away 🙁. 
Thank you for sharing the word of Habuild with your friends! 🙏☺

To fix this, just remind them to verify their registration (super simple, like confirming an OTP) 📱. 
...
add some extra pont inthe not verifed : To fix this, just remind them to verify their registration (super simple, like confirming an OTP) 📱. 
 Go to https://me.habuild.in/myreferals and click Invite next to their name
